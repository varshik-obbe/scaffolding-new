...
exports.add_ProformaInvoice = (req, res) => {
  ...
  const invoice = new ProformaInvoice({
    ...
    transitamount: data.transitamount,
    total: data.total,
    ...
    .then(invoicedata => {
      const response = {
        ...
        invoicedata: invoicedata.map(quotation => ({
          ...
          transit: quotation.transit,
          transitamount: quotation.transitamount,
...
exports.update_proformainvoice = (req,res) =>{
  ...
  ProformaInvoice.findOne({_id: req.body.data._id}, function (err, founddata) {
      if (err) 
          ...
          founddata.transit = req.body.data.transit,
          founddata.transitamount = req.body.data.transitamount,
